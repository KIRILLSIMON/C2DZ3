...
public class Train extends Transport{private int cost;
    private int time;
    ...
    public Train(String brand, String model,
                 int productionYear, String country,
                 String color, int maxSpeed,
                 String fuel, double percentageFuel,
                 int cost, int time,
                 String departureStation,
                 String arrivalStation, int wagons)
    {
